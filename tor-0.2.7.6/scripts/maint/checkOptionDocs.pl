...
open(F, "/home/milad/Downloads/tor-0.2.7.6/src/or/tor --list-torrc-options |") or die;
while (<F>) {
...
loadTorrc("/home/milad/Downloads/tor-0.2.7.6/src/config/torrc.sample.in", \%torrcSampleOptions);

# Try to figure out what's in the man page.

my $considerNextLine = 0;
open(F, "/home/milad/Downloads/tor-0.2.7.6/doc/tor.1.txt") or die;
while (<F>) {
